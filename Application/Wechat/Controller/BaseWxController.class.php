...
if(!defined("COMPONENT_APPID"))
    define('COMPONENT_APPID', "wx44c377ff043ee764");
//AppSecret
if(!defined("COMPONENT_APPSECRET"))
    define('COMPONENT_APPSECRET', "xxxxxxxxxxx");
//TOKEN
define('SQ_TOKEN', "hZJ6fC3Rr3BHc3jR683hSf13p3s7lfbr");
//公众号消息加解密Key
define('SQ_ENCODINGAESKEY', "kjJlI5Z3ycmi8lWEIHwOcUF42QwyZw1tBl9WHJqwDUw");
